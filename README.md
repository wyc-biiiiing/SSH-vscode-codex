...
重点是后面两句，含义就是服务器上的 127.0.0.1:17890 会通过SSH隧道回到本机的 Clash 127.0.0.1:7897。前面的端口号17890是随便选的一个远端监听端口， 只是为了避免端口冲突挑了个不常用的号，也可以换成其他的，只要不冲突就行。后面的端口号7897就是前面看的本地代理端口
